import { API, TIKTOK_API, publicAI } from "./api.js"
...
async function sendAIMessage() {
  ...
  try {
    ...
    console.log("MAXIEL AI RESPONSE:", data)
    ...
    if (!answer) {
      throw new Error("Response AI tidak dikenali")
    }
    ...
    console.error("MAXIEL AI ERROR:", err)

    addAIMessage(
      "Maaf, AI sedang mengalami masalah: " + err.message,
      "bot"
    )
